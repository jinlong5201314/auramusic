(function () {
    const translations = {
        ...
        "灵光音乐 (AuraMusic) 融合流体美学与智能多源容灾调度，歌曲数据由开源社区与公共接口驱动。仅供个人学习交流与视听体验，请支持正版音乐。": "AuraMusic integrates fluid aesthetics with smart multi-source failover. Audio powered by open source communities and public APIs. For educational purposes only, please support official releases.",
